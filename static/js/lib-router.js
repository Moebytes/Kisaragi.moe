"use strict";
(self["webpackChunkkisaragi_site"] = self["webpackChunkkisaragi_site"] || []).push([["535"], {
1344(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var Action = /* @__PURE__ */ (/* unused pure expression or super */ null && (((Action2) => {
  Action2["Pop"] = "POP";
  Action2["Push"] = "PUSH";
...
var IDLE_NAVIGATION = (/* unused pure expression or super */ null && ({
  state: "idle",
  location: void 0,
  formMethod: void 0,
  formAction: void 0,
...
var IDLE_FETCHER = (/* unused pure expression or super */ null && ({
  state: "idle",
  data: void 0,
  formMethod: void 0,
  formAction: void 0,
...
var IDLE_BLOCKER = (/* unused pure expression or super */ null && ({
  state: "unblocked",
  proceed: void 0,
  reset: void 0,
  location: void 0
...
var DataRouterContext = react__rspack_import_0.createContext(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = react__rspack_import_0.createContext(null);
DataRouterStateContext.displayName = "DataRouterState";
var RSCRouterContext = react__rspack_import_0.createContext(false);
function useIsRSCRouterContext() {
  return react__rspack_import_0.useContext(RSCRouterContext);
}
var ViewTransitionContext = react__rspack_import_0.createContext({
  isTransitioning: false
});
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = react__rspack_import_0.createContext(
  /* @__PURE__ */ new Map()
);
FetchersContext.displayName = "Fetchers";
var AwaitContext = react__rspack_import_0.createContext(null);
AwaitContext.displayName = "Await";
var AwaitContextProvider = (props) => React.createElement(AwaitContext.Provider, props);
var NavigationContext = react__rspack_import_0.createContext(
  null
);
NavigationContext.displayName = "Navigation";
var LocationContext = react__rspack_import_0.createContext(
  null
);
LocationContext.displayName = "Location";
var RouteContext = react__rspack_import_0.createContext({
  outlet: null,
  matches: [],
  isDataRoute: false
});
RouteContext.displayName = "Route";
var RouteErrorContext = react__rspack_import_0.createContext(null);
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator } = react__rspack_import_0.useContext(NavigationContext);
...
function useNavigate() {
  let { isDataRoute } = react__rspack_import_0.useContext(RouteContext);
...
function useNavigateUnstable() {
  ...
  let { basename, navigator } = react__rspack_import_0.useContext(NavigationContext);
  let { matches } = react__rspack_import_0.useContext(RouteContext);
  ...
  let navigate = react__rspack_import_0.useCallback(
    (to, options = {}) => {
...
var OutletContext = react__rspack_import_0.createContext(null);
...
function useRoutesImpl(routes, locationArg, dataRouterOpts) {
  ...
  let { navigator } = react__rspack_import_0.useContext(NavigationContext);
  let { matches: parentMatches } = react__rspack_import_0.useContext(RouteContext);
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  if (locationArg && renderedMatches) {
    return /* @__PURE__ */ react__rspack_import_0.createElement(
...
function DefaultErrorComponent() {
  ...
  if (ENABLE_DEV_WARNINGS) {
    ...
    devInfo = /* @__PURE__ */ react__rspack_import_0.createElement(react__rspack_import_0.Fragment, null, /* @__PURE__ */ react__rspack_import_0.createElement("p", null, "\u{1F4BF} Hey developer \u{1F44B}"), /* @__PURE__ */ react__rspack_import_0.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /* @__PURE__ */ react__rspack_import_0.createElement("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", /* @__PURE__ */ react__rspack_import_0.createElement("code", { style: codeStyles }, "errorElement"), " prop on your route."));
  }
  return /* @__PURE__ */ react__rspack_import_0.createElement(react__rspack_import_0.Fragment, null, /* @__PURE__ */ react__rspack_import_0.createElement("h2", null, "Unexpected Application Error!"), /* @__PURE__ */ react__rspack_import_0.createElement("h3", { style: { fontStyle: "italic" } }, message), stack ? /* @__PURE__ */ react__rspack_import_0.createElement("pre", { style: preStyles }, stack) : null, devInfo);
}
var defaultErrorElement = /* @__PURE__ */ react__rspack_import_0.createElement(DefaultErrorComponent, null);
var RenderErrorBoundary = class extends react__rspack_import_0.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let result = error !== void 0 ? /* @__PURE__ */ react__rspack_import_0.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ react__rspack_import_0.createElement(
    ...
    if (this.context) {
      return /* @__PURE__ */ react__rspack_import_0.createElement(RSCErrorHandler, { error }, result);
    }
    return result;
  }
};
...
function RSCErrorHandler({
  ...
  let { basename } = react__rspack_import_0.useContext(NavigationContext);
...
function RenderedRoute({ routeContext, match, children }) {
  ...
  return /* @__PURE__ */ react__rspack_import_0.createElement(RouteContext.Provider, { value: routeContext }, children);
}
function _renderMatches(matches, parentMatches = [], dataRouterOpts) {
  ...
  return renderedMatches.reduceRight(
    (outlet, match, index) => {
      ...
      return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? /* @__PURE__ */ react__rspack_import_0.createElement(
        RenderErrorBoundary,
        {
          location: dataRouterState.location,
...
var useOptimisticImpl = /*#__PURE__*/ (react__rspack_import_0_namespace_cache || (react__rspack_import_0_namespace_cache = __webpack_require__.t(react__rspack_import_0, 2)))[USE_OPTIMISTIC];
...
var MemoizedDataRoutes = react__rspack_import_0.memo(DataRoutes);
function DataRoutes({
  routes,
  future,
  state,
...
function Navigate({
  ...
  let { static: isStatic } = react__rspack_import_0.useContext(NavigationContext);
  warning(
    !isStatic,
...
function Router({
  ...
  return /* @__PURE__ */ react__rspack_import_0.createElement(NavigationContext.Provider, { value: navigationContext }, /* @__PURE__ */ react__rspack_import_0.createElement(LocationContext.Provider, { children, value: locationContext }));
}
function Routes({
  children,
  location
...
var AwaitErrorBoundary = class extends react__rspack_import_0.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2 /* error */) {
      return /* @__PURE__ */ react__rspack_import_0.createElement(AwaitContext.Provider, { value: promise, children: errorElement });
    }
    if (status === 1 /* success */) {
      return /* @__PURE__ */ react__rspack_import_0.createElement(AwaitContext.Provider, { value: promise, children });
    }
    throw promise;
  }
};
...
function createRoutesFromChildren(children, parentPath = []) {
  ...
  react__rspack_import_0.Children.forEach(children, (element, index) => {
    if (!react__rspack_import_0.isValidElement(element)) {
      return;
    }
...
function useDataRouterContext2() {
  let context = react__rspack_import_0.useContext(DataRouterContext);
  invariant2(
    context,
...
function useDataRouterStateContext() {
  let context = react__rspack_import_0.useContext(DataRouterStateContext);
  invariant2(
    context,
...
var FrameworkContext = react__rspack_import_0.createContext(void 0);
FrameworkContext.displayName = "FrameworkContext";
function useFrameworkContext() {
  let context = react__rspack_import_0.useContext(FrameworkContext);
  invariant2(
    context,
...
function usePrefetchBehavior(prefetch, theirElementProps) {
  let frameworkContext = react__rspack_import_0.useContext(FrameworkContext);
  let [maybePrefetch, setMaybePrefetch] = react__rspack_import_0.useState(false);
  let [shouldPrefetch, setShouldPrefetch] = react__rspack_import_0.useState(false);
  let { onFocus, onBlur, onMouseEnter, onMouseLeave, onTouchStart } = theirElementProps;
  let ref = react__rspack_import_0.useRef(null);
  react__rspack_import_0.useEffect(() => {
    if (prefetch === "render") {
...
function PrefetchPageLinks({ page, ...linkProps }) {
  ...
  let matches = react__rspack_import_0.useMemo(
  ...
  return /* @__PURE__ */ react__rspack_import_0.createElement(PrefetchPageLinksImpl, { page, matches, ...linkProps });
}
function useKeyedPrefetchLinks(matches) {
  let { manifest, routeModules } = useFrameworkContext();
  let [keyedPrefetchLinks, setKeyedPrefetchLinks] = react__rspack_import_0.useState([]);
  react__rspack_import_0.useEffect(() => {
...
function PrefetchPageLinksImpl({
  ...
  let newMatchesForData = react__rspack_import_0.useMemo(
  ...
  let newMatchesForAssets = react__rspack_import_0.useMemo(
    () => getNewMatchesForLinks(
      page,
      nextMatches,
      matches,
  ...
  let dataHrefs = react__rspack_import_0.useMemo(() => {
  ...
  let moduleHrefs = react__rspack_import_0.useMemo(
    () => getModuleLinkHrefs(newMatchesForAssets, manifest),
    [newMatchesForAssets, manifest]
  );
  let keyedPrefetchLinks = useKeyedPrefetchLinks(newMatchesForAssets);
  return /* @__PURE__ */ react__rspack_import_0.createElement(react__rspack_import_0.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ react__rspack_import_0.createElement("link", { key: href, rel: "prefetch", as: "fetch", href, ...linkProps })), moduleHrefs.map((href) => /* @__PURE__ */ react__rspack_import_0.createElement("link", { key: href, rel: "modulepreload", href, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => (
...
function Scripts(scriptProps) {
  ...
  let initialScripts = react__rspack_import_0.useMemo(() => {
...
import(${JSON.stringify(manifest.entry.module)});`;
    return /* @__PURE__ */ react__rspack_import_0.createElement(react__rspack_import_0.Fragment, null, /* @__PURE__ */ react__rspack_import_0.createElement(
      "script",
      {
        ...scriptProps,
  ...
  return isHydrated || isRSCRouterContext ? null : /* @__PURE__ */ react__rspack_import_0.createElement(react__rspack_import_0.Fragment, null, typeof manifest.sri === "object" ? /* @__PURE__ */ react__rspack_import_0.createElement(
    "script",
    {
      ...scriptProps,
      "rr-importmap": "",
  ...
  ) : null, !enableFogOfWar ? /* @__PURE__ */ react__rspack_import_0.createElement(
    "link",
    {
      rel: "modulepreload",
      href: manifest.url,
  ...
  ) : null, /* @__PURE__ */ react__rspack_import_0.createElement(
    "link",
    {
      rel: "modulepreload",
  ...
  ), preloads.map((path) => /* @__PURE__ */ react__rspack_import_0.createElement(
    "link",
    {
      key: path,
      rel: "modulepreload",
...
// lib/dom/ssr/errorBoundaries.tsx
var RemixErrorBoundary = class extends react__rspack_import_0.Component {
  constructor(props) {
    super(props);
...
function RemixRootDefaultErrorBoundary({
  ...
  console.error(error);
  let heyDeveloper = /* @__PURE__ */ react__rspack_import_0.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
  ...
  if (isRouteErrorResponse(error)) {
    return /* @__PURE__ */ react__rspack_import_0.createElement(BoundaryShell, { title: "Unhandled Thrown Response!" }, /* @__PURE__ */ react__rspack_import_0.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), ENABLE_DEV_WARNINGS ? heyDeveloper : null);
  }
  let errorInstance;
  ...
  return /* @__PURE__ */ react__rspack_import_0.createElement(
    ...
    /* @__PURE__ */ react__rspack_import_0.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"),
    /* @__PURE__ */ react__rspack_import_0.createElement(
      "pre",
      {
        style: {
...
function BoundaryShell({
  ...
  return /* @__PURE__ */ react__rspack_import_0.createElement("html", { lang: "en" }, /* @__PURE__ */ react__rspack_import_0.createElement("head", null, /* @__PURE__ */ react__rspack_import_0.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ react__rspack_import_0.createElement(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), /* @__PURE__ */ react__rspack_import_0.createElement("title", null, title)), /* @__PURE__ */ react__rspack_import_0.createElement("body", null, /* @__PURE__ */ react__rspack_import_0.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children, renderScripts ? /* @__PURE__ */ react__rspack_import_0.createElement(Scripts, null) : null)));
}
...
function BrowserRouter({
  ...
  let setState = react__rspack_import_0.useCallback(
    (newState) => {
      if (unstable_useTransitions === false) {
        setStateImpl(newState);
      } else {
...
var Link = react__rspack_import_0.forwardRef(
  function LinkWithRef({
    ...
    let { basename, navigator, unstable_useTransitions } = react__rspack_import_0.useContext(NavigationContext);
    ...
    return shouldPrefetch && !isAbsolute ? /* @__PURE__ */ react__rspack_import_0.createElement(react__rspack_import_0.Fragment, null, link, /* @__PURE__ */ react__rspack_import_0.createElement(PrefetchPageLinks, { page: href })) : link;
  }
);
Link.displayName = "Link";
var NavLink = react__rspack_import_0.forwardRef(
  function NavLinkWithRef({
    ...
    let location = useLocation();
    let routerState = react__rspack_import_0.useContext(DataRouterStateContext);
    let { navigator, basename } = react__rspack_import_0.useContext(NavigationContext);
...
var Form = react__rspack_import_0.forwardRef(
  ({
    discover = "render",
    fetcherKey,
    navigate,
    ...
    let { unstable_useTransitions } = react__rspack_import_0.useContext(NavigationContext);
...
function ScrollRestoration({
  ...
  let remixContext = react__rspack_import_0.useContext(FrameworkContext);
  let { basename } = react__rspack_import_0.useContext(NavigationContext);
  let location = useLocation();
  let matches = useMatches();
  useScrollRestoration({ getKey, storageKey });
  let ssrKey = react__rspack_import_0.useMemo(
    () => {
...
function useFormAction(action, { relative } = {}) {
  let { basename } = react__rspack_import_0.useContext(NavigationContext);
  let routeContext = react__rspack_import_0.useContext(RouteContext);
