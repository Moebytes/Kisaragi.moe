...
const TermsOfService: React.FunctionComponent<Props> = (props) => {
    ...
    return (
        <>
        <Navbar/>
        <main className={(colorChange ? "tos-container tos-container-blue" : "tos-container") + (transitionOff ? "" : " tos-transition")}>
